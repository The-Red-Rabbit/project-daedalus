...
export function createBots(game, opts = {}) {
  ...
  // Treibt die Bots: loesen nach Ablauf ihres Timers ueber den echten game.solve().
  // Meist korrekt, manchmal bewusst daneben, damit der Statusverfall sichtbar wird.
  function tick(dt, running) {
    ...
    for (const b of bots.values()) {
      ...
      if (res.geloest) reseatOne(b);
      else b.timer = RETRY_SEC;
    }
  }
